...
export class CanvasUiElements {
  ...
  static getLoadData = (
    ...
    const QUANTITY = Math.round(LEGTH / DIVISOR);
  ...
  static getMomentData = (
    ...
    const START = MOMENT_NEGATIVE ? 50 : 130;
    const END = MOMENT_NEGATIVE ? 310 : 230;
